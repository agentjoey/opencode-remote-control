...
describe('OpencodeBackend', () => {
  it('reports id + capabilities (tuiSelect gated on baseUrl)', () => {
    ...
    expect(withUrl.capabilities).toEqual({ liveMirror: true, tuiSelect: true, workspaces: true, freeformWorkspace: false, diff: true, todos: true, catalog: true, mcp: true, commands: true })
